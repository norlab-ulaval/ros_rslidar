...
{
public:
  Input(std::shared_ptr<rclcpp::Node> node, uint16_t port);
...
{
public:
  InputSocket(std::shared_ptr<rclcpp::Node> node, uint16_t port = MSOP_DATA_PORT_NUMBER);
...
{
public:
  InputPCAP(std::shared_ptr<rclcpp::Node> node, uint16_t port = MSOP_DATA_PORT_NUMBER, double packet_rate = 0.0,
